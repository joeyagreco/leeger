...
class League(UniqueId):
    ...
    def statSheet(self, **kwargs) -> AllTimeStatSheet:
        ...
        from src.leeger.calculator.all_time_calculator.PlusMinusAllTimeCalculator import PlusMinusAllTimeCalculator
        from src.leeger.calculator.all_time_calculator.PointsScoredAllTimeCalculator import \
        ...
        from src.leeger.calculator.all_time_calculator.ScoringShareAllTimeCalculator import \
