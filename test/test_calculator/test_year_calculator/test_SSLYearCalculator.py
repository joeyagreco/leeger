...
class TestSSLYearCalculator(unittest.TestCase):
    ...
    def test_getTeamLuckPerGame_happyPath(self):
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year)
    ...
    def test_getTeamLuckPerGame_noneIfNoGamesPlayed(self):
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, weekNumberEnd=1)
    ...
    def test_getTeamLuckPerGame_onlyPostSeasonIsTrue(self):
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, onlyPostSeason=True)
    ...
    def test_getTeamLuckPerGame_onlyRegularSeasonIsTrue(self):
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, onlyRegularSeason=True)
    ...
    def test_getTeamLuckPerGame_onlyChampionshipIsTrue(self):
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, onlyChampionship=True)
    ...
    def test_getTeamLuckPerGame_weekNumberStartGiven(self):
        owners, teams = getNDefaultOwnersAndTeams(2)
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, weekNumberStart=2)
    ...
    def test_getTeamLuckPerGame_weekNumberEndGiven(self):
        owners, teams = getNDefaultOwnersAndTeams(2)
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, weekNumberEnd=2)
    ...
    def test_getTeamLuckPerGame_weekNumberStartGivenAndWeekNumberEndGiven(self):
        owners, teams = getNDefaultOwnersAndTeams(2)
        ...
        response = SSLYearCalculator.getTeamLuckPerGame(year, weekNumberStart=2, weekNumberEnd=3)
