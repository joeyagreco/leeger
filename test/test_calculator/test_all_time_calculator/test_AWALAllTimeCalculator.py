...
class TestAWALAllTimeCalculator(unittest.TestCase):
    def test_getAWAL_happyPath(self):
        ...
        matchup2_a = Matchup(
            teamAId=teamsA[2].id, teamBId=teamsA[3].id, teamAScore=3, teamBScore=4
        )
        matchup3_a = Matchup(
            teamAId=teamsA[4].id, teamBId=teamsA[5].id, teamAScore=4, teamBScore=5
        )
        ...
        matchup2_b = Matchup(
            teamAId=teamsB[2].id, teamBId=teamsB[3].id, teamAScore=3, teamBScore=4
        )
        matchup3_b = Matchup(
            teamAId=teamsB[4].id, teamBId=teamsB[5].id, teamAScore=4, teamBScore=5
        )
        ...
        matchup3_c = Matchup(
            teamAId=teamsC[4].id, teamBId=teamsC[5].id, teamAScore=4, teamBScore=5
        )
    ...
    def test_getAWAL_leagueMedianGamesIsOn_addsLeagueMedianWinsToAWAL(self):
        ...
        week1_a = Week(weekNumber=1, matchups=[matchup1_a, matchup2_a, matchup3_a])
        yearA = Year(
            yearNumber=2000, teams=teamsA, weeks=[week1_a], yearSettings=yearSettings
        )
        ...
        week1_b = Week(weekNumber=1, matchups=[matchup1_b, matchup2_b, matchup3_b])
        yearB = Year(
            yearNumber=2001, teams=teamsB, weeks=[week1_b], yearSettings=yearSettings
        )
        ...
        week1_c = Week(weekNumber=1, matchups=[matchup1_c, matchup2_c, matchup3_c])
        yearC = Year(
            yearNumber=2002, teams=teamsC, weeks=[week1_c], yearSettings=yearSettings
        )
    ...
    def test_getAWAL_noneIfNoGamesPlayed(self):
        ...
        matchup2_a = Matchup(
            teamAId=teamsA[1].id, teamBId=teamsA[2].id, teamAScore=3, teamBScore=4
        )
