...
class TestSSLAllTimeCalculator(unittest.TestCase):
    ...
    def test_getTeamScorePerGame_happyPath(self):
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league)

        self.assertIsInstance(response, dict)
        self.assertEqual(2, len(response.keys()))
        self.assertEqual(Deci("66.76666666666666666666666665"), response[owners[0].id])
        self.assertEqual(Deci("233.5333333333333333333333333"), response[owners[1].id])
    ...
    def test_getTeamScorePerGame_noneIfNoGamesPlayed(self):
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, weekNumberEnd=1)
    ...
    def test_getTeamScorePerGame_onlyPostSeasonIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, onlyPostSeason=True)
    ...
    def test_getTeamScorePerGame_onlyRegularSeasonIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, onlyRegularSeason=True)
    ...
    def test_getTeamScorePerGame_onlyChampionshipIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, onlyChampionship=True)
        ...
        self.assertIsNone(response[owners[2].id])
        self.assertIsNone(response[owners[3].id])
        self.assertEqual(Deci("89.7768840579710144927536232"), response[owners[4].id])
        self.assertEqual(Deci("211.1631159420289855072463768"), response[owners[5].id])

    def test_getTeamScorePerGame_yearNumberStartGivenWeekNumberStartGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, yearNumberStart=2001, weekNumberStart=1)
    ...
    def test_getTeamScorePerGame_yearNumberEndGivenWeekNumberEndGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamScorePerGame(league, yearNumberEnd=2001, weekNumberEnd=1)
    ...
    def test_getTeamScorePerGame_yearNumberStartGivenWeekNumberStartGivenAndYearNumberEndGivenWeekNumberEndGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
    ...
    def test_getTeamSuccessPerGame_happyPath(self):
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league)
    ...
    def test_getTeamSuccessPerGame_noneIfNoGamesPlayed(self):
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, weekNumberEnd=1)
    ...
    def test_getTeamSuccessPerGame_onlyPostSeasonIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, onlyPostSeason=True)
    ...
    def test_getTeamSuccessPerGame_onlyRegularSeasonIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, onlyRegularSeason=True)
    ...
    def test_getTeamSuccessPerGame_onlyChampionshipIsTrue(self):
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, onlyChampionship=True)
    ...
    def test_getTeamSuccessPerGame_yearNumberStartGivenWeekNumberStartGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, yearNumberStart=2001, weekNumberStart=1)
    ...
    def test_getTeamSuccessPerGame_yearNumberEndGivenWeekNumberEndGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamSuccessPerGame(league, yearNumberEnd=2001, weekNumberEnd=1)
    ...
    def test_getTeamSuccessPerGame_yearNumberStartGivenWeekNumberStartGivenAndYearNumberEndGivenWeekNumberEndGiven(
            self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
    ...
    def test_getTeamLuckPerGame_happyPath(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league)
    ...
    def test_getTeamLuckPerGame_noneIfNoGamesPlayed(self):
        owners, teamsA = getNDefaultOwnersAndTeams(3)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, weekNumberEnd=1)
    ...
    def test_getTeamLuckPerGame_onlyPostSeasonIsTrue(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, onlyPostSeason=True)
    ...
    def test_getTeamLuckPerGame_onlyRegularSeasonIsTrue(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, onlyRegularSeason=True)
    ...
    def test_getTeamLuckPerGame_onlyChampionshipIsTrue(self):
        owners, teamsA = getNDefaultOwnersAndTeams(6)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, onlyChampionship=True)
    ...
    def test_getTeamLuckPerGame_yearNumberStartGivenWeekNumberStartGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, yearNumberStart=2001, weekNumberStart=1)
    ...
    def test_getTeamLuckPerGame_yearNumberEndGivenWeekNumberEndGiven(self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
        ...
        response = SSLAllTimeCalculator.getTeamLuckPerGame(league, yearNumberEnd=2001, weekNumberEnd=1)
    ...
    def test_getTeamLuckPerGame_yearNumberStartGivenWeekNumberStartGivenAndYearNumberEndGivenWeekNumberEndGiven(
            self):
        owners, teamsA = getNDefaultOwnersAndTeams(2)
        teamsB = getTeamsFromOwners(owners)
        teamsC = getTeamsFromOwners(owners)
