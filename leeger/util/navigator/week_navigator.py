...
def getTeamIdsAndOpponentScores(week: Week, weekFilters: WeekFilters) -> dict[str, float | int]:
    """
...
def getNumberOfValidTeamsInWeek(week: Week, weekFilters: WeekFilters) -> int:
    """
