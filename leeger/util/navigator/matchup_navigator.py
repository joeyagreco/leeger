...
def getTeamIdOfMatchupWinner(matchup: Matchup) -> Optional[str]:
    """
...
def simplifyMultiWeekMatchups_(matchups: list[Matchup]) -> Matchup:
    """
...
def getMedianScore(matchups: list[Matchup]) -> float:
    """
